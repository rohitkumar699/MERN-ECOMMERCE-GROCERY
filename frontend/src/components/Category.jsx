...
const Category = () => {
  ...
  const colors = [
    "bg-red-300","bg-green-300","bg-blue-300","bg-cyan-300",
  ...
  return (
    <div className="py-12">
      ...
      <h2 className="mt-4 text-secondary font-extrabold text-3xl">Shop By Collection</h2>
      <Swiper
        modules={[Autoplay]}
        ...
        {categoriesData.map((category, i) => (
          <SwiperSlide key={i}>
            <motion.div
              ...
              className={`w-[130px] md:w-[150px] h-[170px] rounded-md ${colors[i % colors.length]} flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-all duration-300`}
            >
              <img
